...
VBoxManage storageattach "$VM_NAME" --storagectl SATA --type hdd --hotpluggable off --port 0 --device 0 --medium /home/nnm/sailfish-sdk-install-test/emulator/sailfishos.vdi
