...
INSTALL_DIR=$1
mkdir -p $INSTALL_DIR
echo "Copying SDK tools to $INSTALL_DIR...\n"
...
echo "Deleting emulator devices...\n"
...
echo "Deleting MER targets...\n"
rm -f $INSTALL_DIR/mersdk/targets/targets.xml
echo "Creating MER targets...\n"
$INSTALL_DIR/libexec/qtcreator/sdktool addMerTarget --mer-targets-dir "$INSTALL_DIR/mersdk/targets" --target-name "SailfishOS-2.2.1.18-i486" --qmake-query "$INSTALL_DIR/mersdk/dumps/qmake.query.SailfishOS-2.2.1.18-i486" --gcc-dumpmachine "$INSTALL_DIR/mersdk/dumps/gcc.dumpmachine.SailfishOS-2.2.1.18-i486"
$INSTALL_DIR/libexec/qtcreator/sdktool addMerTarget --mer-targets-dir "$INSTALL_DIR/mersdk/targets" --target-name "SailfishOS-2.2.1.18-armv7hl" --qmake-query "$INSTALL_DIR/mersdk/dumps/qmake.query.SailfishOS-2.2.1.18-armv7hl" --gcc-dumpmachine "$INSTALL_DIR/mersdk/dumps/gcc.dumpmachine.SailfishOS-2.2.1.18-armv7hl"
